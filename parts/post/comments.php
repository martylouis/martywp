<!-- <section class="post-comments">
  <div class="post-facebook-comments card-bordered mt2">
      ...
      <nav>
        <ul class="pager">
          <?php if (get_previous_comments_link()) : ?>
            <li class="previous"><?php previous_comments_link(__('&larr; Older comments', '_base')); ?></li>
          <?php endif; ?>
          <?php if (get_next_comments_link()) : ?>
            <li class="next"><?php next_comments_link(__('Newer comments &rarr;', '_base')); ?></li>
          <?php endif; ?>
        </ul>
      </nav>
    <?php endif; ?>
  ...
  <?php if (!comments_open() && get_comments_number() != '0' && post_type_supports(get_post_type(), 'comments')) : ?>
    <div>
      <div class="alert alert-warning">
        <?php _e('Comments are closed.', '_base'); ?>
      </div>
    </div>
  <?php endif; ?>
