...
if (current_theme_supports('bootstrap-gallery')) {
  ...
  add_shortcode('gallery', '_base_gallery');
 ...
 */
function _base_attachment_link_class($html) {
  $html = str_replace('<a', '<a class="thumbnail img-thumbnail"', $html);
  return $html;
}
add_filter('wp_get_attachment_link', '_base_attachment_link_class', 10, 1);
